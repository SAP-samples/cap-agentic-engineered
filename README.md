...
Copy `CLAUDE.md` and `skills/` into your own CAP + Fiori Elements project, configure the MCP servers in `.claude/settings.json` (instructions inside the file), and your AI coding agent will automatically query the right server for each task.
